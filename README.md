...
This project integrates **Google Gemini AI** for resume analysis and includes secure authentication features like email verification and password reset using **SMTP mail** and job suggestions using **Adzuna API**.
...
```bash
git clone https://github.com/Chirag02909/Resume-Analyser.git
```
...
spring.mail.username=${gname}
spring.mail.password=${gpass}
...
- Email functionality works **only with SMTP email service**.  
